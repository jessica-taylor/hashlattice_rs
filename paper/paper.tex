...
\begin{document}
    ...
    \section{Semilattices as a category}
      ...
      The total space $\mathrm{Tot}(L, g)$ is a preorder whose elements consist of pairs $(x, x')$ where $x : L$ and $x' : g(x)$. We consider $(x, x') \leq (y, y')$ when $x \leq y$ and $g(x \leq y)(x') \leq y'$. The total space is a semilattice, as shown:
    ...
    \section{De-categorizing semilattice fibrations}
      ...
      A semilattice fibration consists of a function $g_l : L \rightarrow \mathrm{Semilattice}$, assigning to each element of $L$ a semilattice, and a function $g_t : \Pi (x, y : L, x \leq y) g_l(x) \rightarrow g_l(y)$ (a ``transport function''), satisfying:
      ...
      The total space $\mathrm{SemiTot}(L, g_l, g_t)$ is then a semilattice whose elements are pairs $(x, x')$ where $x : L$ and $x' : g_l(x)$. The join is defined as $(x, x') \vee (y, y') := (x \vee y, g_t(x, x \vee y, x') \vee g_t(y, x \vee y, y'))$. This is equivalent to the above category-theoretic definition, proving it is a semilattice.
    ...
    \section{Composing semilattice fibrations}
      ...
      \begin{align*}
        (g_{n, l}, g_{n, t}) &: \mathrm{SemiFibration}(T_{n-1}) & \text{ for natural $n \geq 1$ } \\
        T_n &:= \mathrm{SemiTot}(T_{n-1}, g_{n, l}, g_{n, t})    & \text{ for natural $n \geq 1$ }
      \end{align*}

      We now wish to define $L_\omega$ to be a semilattice that is, morally speaking, the limit of $L_n$. This lattice's elements are infinite lists $x_1, x_2, \ldots$ satisfying $x_n : g_{n, l}(x_{<n})$ for each natural $n \geq 1$, where $x_{<n} = x_1, \ldots, x_{n-1} : T_{n-1}$. The joins are defined as follows:

      $$(\overline{x} \vee \overline{y})_n := g_{n, t}(x_{<n}, x_{<n} \vee y_{<n}, x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n})} g_{n, t}(y_{<n}, x_{<n} \vee y_{<n}, y_n)$$
        ...
        \begin{itemize}
          \item \emph{Commutativity}:
            \begin{align*}
              ...
              &= g_{n, t}(x_{<n}, x_{<n} \vee y_{<n})(x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n})} g_{n, t}(y_{<n}, x_{<n} \vee y_{<n}, y_n) \\
              &= g_{n, t}(y_{<n}, y_{<n} \vee x_{<n})(y_n) \vee_{g_{n, l}(y_{<n} \vee x_{<n})} g_{n, t}(x_{<n}, y_{<n} \vee x_{<n}, x_n) \\
              &= (\overline{y} \vee \overline{x})_n
            \end{align*}
          \item \emph{Associativity}:
            \begin{align*}
              & ((\overline{x} \vee \overline{y}) \vee \overline{z})_n \\
              =& g_{n, t}(x_{<n} \vee y_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, (\overline{x} \vee \overline{y})_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})}
                 g_{n, t}(z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, z_n)  \\
              =& g_{n, t}(x_{<n} \vee y_{<n}, x_{<n} \vee y_{<n} \vee z_{<n},
                          g_{n, t}(x_{<n}, x_{<n} \vee y_{<n}, x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n})}
                          g_{n, t}(y_{<n}, x_{<n} \vee y_{<n}, y_n)) \\
               &\vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} g_{n, t}(z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, z_n)  \\
              =& g_{n, t}(x_{<n} \vee y_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, g_{n, t}(x_{<n}, x_{<n} \vee y_{<n}, x_n)) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(x_{<n} \vee y_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, g_{n, t}(y_{<n}, x_{<n} \vee y_{<n}, y_n)) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, z_n)  \\
              =& g_{n, t}(x_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(y_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, y_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, z_n)  \\
              =& g_{n, t}(x_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(y_{<n} \vee z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, g_{n, t}(y_{<n}, y_{<n} \vee z_{<n}, y_n)) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(y_{<n} \vee z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, g_{n, t}(z_{<n}, y_{<n} \vee z_{<n}, z_n))  \\
              =& g_{n, t}(x_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(y_{<n} \vee z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n},
                          g_{n, t}(y_{<n}, y_{<n} \vee z_{<n}, y_n) \vee_{g_{n, l}(y_{<n} \vee z_{<n})}
                          g_{n, t}(z_{<n}, y_{<n} \vee z_{<n}, z_n)) \\
              =& g_{n, t}(x_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, x_n) \vee_{g_{n, l}(x_{<n} \vee y_{<n} \vee z_{<n})} \\
               & g_{n, t}(y_{<n} \vee z_{<n}, x_{<n} \vee y_{<n} \vee z_{<n}, (\overline{y} \vee \overline{z})_n) \\
              =& (\overline{x} \vee (\overline{y} \vee \overline{z}))_n
            \end{align*}
          \item \emph{Idempotence}:
            \begin{align*}
              (\overline{x} \vee \overline{x})_n &= g_{n, t}(x_{<n}, x_{<n} \vee x_{<n})(x_n) \vee_{g_{n, l}(x_{<n} \vee x_{<n}))} g_{n, t}(x_{<n}, x_{<n} \vee x_{<n}, x_n) \\
              &= g_{n, t}(x_{<n}, x_{<n}, x_n) \\
              &= x_n
            \end{align*}
        \end{itemize}
      \end{proof}
