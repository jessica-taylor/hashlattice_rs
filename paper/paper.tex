...
\begin{document}
    ...
    \section{Composing semilattice fibrations}
      ...
      Let $L_0$ be an arbitrary semilattice. Now suppose we have:
      ...
      We can further stack to higher ordinals than $\omega$. Let $n_u \geq 1$ be the number of universes. Let $L_{0, 0}$ be an arbitrary semilattice. Assume we have:
      ...
      \begin{align*}
        ...
        L_{u+1, 0} &:= L_{u, \omega} & \text{ for natural $0 \leq u < n_u - 1$ }
      \end{align*}
